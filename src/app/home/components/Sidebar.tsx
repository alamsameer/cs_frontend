...
export default function Sidebar({toggleNav,isNavOpen}: SideBarProps) {
  ...
  return (
    <div className={`z-20 bg-sky-600 shrink-0 transition-all ${isNavOpen?"":"-translate-x-full "} w-48 h-full space-y-1 fixed top-0 bottom-0 left-0 sm:relative`}>
      <div><p className=" text-4xl text-center my-3 font-bold text-white ">Mandi</p></div>
        ...
        <button className="text-foreground w-full px-2 py-1 lg:px-3 hover:bg-secondary my-2 rounded-md"><Link to={'/'}>Dashboard</Link></button>
